...
@Component({
  ...
  template: `
<!-- Skeleton -->
<div *ngIf="loading" data-testid="skeleton" class="animate-pulse">
...
<div *ngIf="!loading">
  ...
  <div class="mt-6 space-y-4">
    <div *ngFor="let item of data" class="flex justify-between items-center">
    ...
    <div *ngIf="data.length === 0" class="text-center text-sm text-on-surface-variant font-body py-4">
      No data yet
    </div>
  </div>
</div>
